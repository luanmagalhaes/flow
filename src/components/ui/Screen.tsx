...
export function Screen({ children, footer, wide = false }: ScreenProps) {
  return (
    <main className="stage-water flex min-h-dvh flex-col">
      ...
      {footer ? (
        <div className="shrink-0 border-t-2 border-ink/15 bg-foam/80 px-5 pb-[calc(var(--safe-bottom)+1rem)] pt-4 backdrop-blur-sm sm:px-8">
